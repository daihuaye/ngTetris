...
.constant('PATTERNS', [
    ...
    [[1, 5, 9, 13], [4, 5, 6, 7], [1, 5, 9, 13], [4, 5, 6, 7]], // stick
    [[1, 4, 5, 6], [1, 5, 6, 9], [4, 5, 6, 9], [1, 4, 5, 9]], // T
    [[1, 5, 8, 9], [0, 4, 5, 6], [1, 2, 5, 9], [4, 5, 6, 10]], // _!
    [[1, 5, 6, 10], [5, 6, 8, 9], [1, 5, 6, 10], [5, 6, 8, 9]], // s
    [[4, 5, 9, 10], [1, 4, 5, 8], [4, 5, 9, 10], [1, 4, 5, 8]] // z
])
.constant('PATTERN_COOR', [
    [[{x: 1, y: 0},{x: 1, y: 1},{x: 1, y: 2},{x: 2, y: 2}], [{x: 0, y: 1},{x: 1, y: 1},{x: 2, y: 1},{x: 1, y: 2}],
